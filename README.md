...
- **Content breadth**: 24 careers (farmer → CEO → digital nomad → cult leader*), 12 birth backgrounds (slum to dynasty to war zone), ~240 events across 6 shards including street-level stories inspired by Chinese documentary storytellers.
